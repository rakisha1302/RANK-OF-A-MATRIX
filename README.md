...
## Algorithm:
###Step 1: 
Import the NumPy module to use mathematical and matrix functions.
###Step 2:
Create a matrix using np.array() and store it in a variable A.
###Step 3:
Using the np.linalg.matrix_rank(), we can find the rank of the given matrix.
###Step 4:
Print the value of X to display the rank of the matrix.
## Program:
```
